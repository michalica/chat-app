  ...
  describe("Chat", () => {
    ...
    describe("MessagesArea", () => {
      it("should exists", () => {
        ...
        const messageArea = wrapper.find(Chat).props()
          .messageArea as ReactElement;
        expect(
          shallow(<div>{messageArea}</div>).find(MessagesArea).length
        ).toBe(1);
      });
