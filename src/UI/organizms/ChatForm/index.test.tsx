...
const setupTest = (): {
    ...
    const input: HTMLInputElement = utils.getByLabelText('message-input') as HTMLInputElement;
    const button: HTMLButtonElement = utils.getByLabelText('submit-message') as HTMLButtonElement;
